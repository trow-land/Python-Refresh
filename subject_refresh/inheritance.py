...
class Knight(User):
    ...
    def attack(self):
        print(f"Attacking with sword attach of power {self.sword_attack}")


# Here we're creating an instance of each type of User.
wizard1 = Wizard("Gandalf", 50)  # Gandalf is a Wizard with a power of 50
archer1 = Archer("Legolas", 100)  # Legolas is an Archer with 100 arrows
knight1 = Knight("Aragorn", 100)  # Aragorn is a Knight with a sword attack power of 100

# Now we're making Gandalf attack. The attack method for a Wizard prints their power.
wizard1.attack()
